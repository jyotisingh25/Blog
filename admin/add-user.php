...
<div class="col-md-9">
<h1> <i class="fa fa-user-plus" aria-hidden="true"></i> Add User <small>Add New Users</small></h1> <hr>
<ol class="breadcrumb">
...
<div class="col-md-8">
 ...
 <input type="text" id="email" name="email" class="form-control"  value="<?php if(isset($email)){echo $email;}?>" placeholder="Email">
 </div>
 <div class="form-group">
