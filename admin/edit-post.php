...
<ol class="breadcrumb">
  ...
  <?php 
    if(isset($_POST['update'])){
		...
		if(empty($up_title) or empty($up_post_data) or empty($up_tags) or empty($up_image)){
			...
			$update_query= "UPDATE posts  SET title= '$up_title', image= '$up_image', categories= '$up_categories', tags= '$up_tags', 
			                post_data= '$up_post_data', status= '$up_status' WHERE id= $edit_id ";
  ...
  <div class="form-group">
      <label for="title">Title:* </label> <?php if(isset($msg)){
