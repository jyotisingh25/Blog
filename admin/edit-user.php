...
<div class="col-md-9">
<h1> <i class="fa fa-user" aria-hidden="true"></i> Edit User <small>Edit users details</small></h1> <hr>
<ol class="breadcrumb">
  ...
  if(isset($_POST['submit'])){
	  ...
	  if(empty($first_name) or empty($last_name) or empty($image)){
		  ...
		  $update_query= "UPDATE `users` SET `first_name` = '$first_name', `last_name` = '$last_name', `image` = '$image', 
