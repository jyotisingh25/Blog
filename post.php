...
<div id="details" class="animated fadeInLeft">
   ...
   <p>WELCOME to custom post page...!!</p>
</div>
</div>
...
<img src="img/<?php echo $author_image; ?>" alt="profile" class="img-circle">
</div>
...
<div class="bottom">
<span class="first"><i class="fa fa-folder" aria-hidden="true"></i>
<a href=""> <?php echo ucfirst($categories); ?></a></span> |
<span class="sec"><i class="fa fa-comment" aria-hidden="true"></i>
...
<img src="img/<?php echo $r_image;?>" alt="img1">
...
<div class="row">
<div class="col-sm-3">
<img src="img/<?php echo $author_image;?>" alt="abc" class="img-circle">
</div>
<div class="col-sm-9">
...
<div class="col-sm-2"><img src="img/<?php echo $c_image;?>" alt="profile picture" class="img-circle"></div>
<div class="col-sm-10"><h4><?php echo ucfirst($c_name);?></h4><p><?php echo $c_comment;?></p></div>
...
if(isset($_POST['submit'])){
	...
	if(empty($cs_name) or empty($cs_email) or empty($cs_comment)){
		$error_msg = "All (*) feilds are Required";
			...
			$cs_query = "INSERT INTO `comments` (`id`, `date`, `name`, `username`, `post_id`, `email`, `website`, `image`, `comment`, `status`) VALUES (NULL, '$cs_date', '$cs_name', 'user', '$post_id', '$cs_email', '$cs_website', 'Man.jpg', '$cs_comment', 'pending')";
...
<textarea id="comment"  name="comment" cols="30" rows="10" placeholder="write here.." class="form-control"><?php if(isset($cs_comment)){echo $cs_comment;}?></textarea>
</div>
